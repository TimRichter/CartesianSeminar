...
-- So, to prove the universal property for foldTree, for any h, f, g of appropriate
...
-- But it would make the code longer and less readable, so we won't do this here.
...
-- 4) The final preliminary before proving the universal property is the following
